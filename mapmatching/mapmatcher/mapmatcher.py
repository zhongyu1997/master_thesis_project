...
def mapMatch(track, segments, decayconstantNet = 100, decayConstantEu = 100, maxDist = 200, addfullpath = True):
    """
...
def getSegmentCandidates(point, segments, decayConstantEu, maxdist=100):
    """
